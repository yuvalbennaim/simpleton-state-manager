...
class comp extends HTMLElement {
  ...
  connectedCallback() {
    ...
    const styleStr = `
      ...
      .login-button{font-family:monospace;width:120px;border:2px solid #61af5a!important;color:#75dd6c!important;background-color:#2b4d28;margin-top:10px;padding:5px;border-radius:5px}
      ...
      .action-button{font-family:monospace;width:100%;border:2px solid #61af5a!important;color:#75dd6c!important;background-color:#2b4d28;margin-top:10px;padding:5px;border-radius:5px;cursor:pointer}
      .add-button{font-family:monospace;border:2px solid #61af5a!important;color:#75dd6c!important;background-color:#2b4d28;margin-top:10px;padding:5px;border-radius:5px;cursor:pointer}
